...
namespace ClassicAssist.UO.Network.PacketFilter
{
    public class PacketFilterInfo
    {
        ...
        public PacketFilterInfo(int packetid, PacketFilterCondition[] conditions, Action<byte[], PacketFilterInfo> onMatch = null)
        {
            PacketID = packetid;
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<PacketFilterCondition[]>.Default.GetHashCode(_conditions);
            hashCode = hashCode * -1521134295 + PacketID.GetHashCode();
            hashCode = hashCode * -1521134295 + EqualityComparer<Action<byte[], PacketFilterInfo>>.Default.GetHashCode(Action);
